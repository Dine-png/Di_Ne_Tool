...
public static class ArmatureScalerCore
{
    ...
    private static string[][] boneNamePatterns = new[]
    {
        ...
        new[] {"Neck", "neck", "Neck_01", "neck_01", "Neck01", "neck01"},
        new[] {"Head"},
        new[] {"LeftShoulder", "Shoulder_Left", "Shoulder_L", "Shoulder.L", "shoulder_L", "shoulder.l", "Left_Shoulder", "Left Shoulder", "Clavicle_L", "clavicle_L", "Clavicle.L"},
        new[] {"RightShoulder", "Shoulder_Right", "Shoulder_R", "Shoulder.R", "shoulder_R", "shoulder.r", "Right_Shoulder", "Right Shoulder", "Clavicle_R", "clavicle_R", "Clavicle.R"},
